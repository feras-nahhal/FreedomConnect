...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['postid'])) {
    $post = new Post();
    $new_content = $_POST['post'];
    $result = $post->edit_post($_POST['postid'], $new_content);
    if ($result) {
...
<body>
    ...
    <div class="post-box">
        <h2>Edit Post</h2>
        <textarea name="post" placeholder="What do you want to edit?"></textarea>
          
                   
        Are you sure you want to edit this post?<br><br>
        ...
        <button id="Post_button" type="submit" value="Edit">Edit</button>
        <br>
    </div>
</form>
