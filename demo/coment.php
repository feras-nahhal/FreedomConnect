...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $post = new Post();
    $result= $post->create_comment($user_id,$_POST,$_FILES,$post_id);
...
<body>
    ...
    <div class="post-box">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="parent" value="<?php echo $postrow['postid'] ?>">
    ...
    <div>
        <?php
        $comment=$Post->get_comments($postrow['postid']);
        if(is_array($comment)){
