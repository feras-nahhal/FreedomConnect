...
<div class="post">
    ...
    <a href="delete.php?id=<?php echo $ROW['postid']; ?>&id2=<?php echo $ROW_user['user_id']; ?>">Delete</a>
    <a href="edite.php?type=post&id=<?php echo $ROW['postid']; ?>&userid=<?php echo $ROW_user['user_id']; ?>">Edit</a>
</div>
